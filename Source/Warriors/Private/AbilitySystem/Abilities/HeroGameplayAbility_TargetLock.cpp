...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	if (!CurrentLockedActor ||
		UWarriorFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, WarriorsGameplayTags::Shared_Status_Dead) ||
	...
	const bool bShouldOverrideRotation =
		!UWarriorFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(),
		                                                 WarriorsGameplayTags::Player_Status_Rolling)
		&&
		!UWarriorFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(),
		                                                 WarriorsGameplayTags::Player_Status_Blocking);
	...
	if (bShouldOverrideRotation)
	{
		...
		LookAtRot -= FRotator(TargetLockCameraOffsetDitance,0.f,0.f);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if(InSwitchDirectionTag == WarriorsGameplayTags::Player_Event_SwitchTarget_Left)
	{
...
void UHeroGameplayAbility_TargetLock::GetAvailableActorsToLock()
{
	...
	UKismetSystemLibrary::BoxTraceMultiForObjects(
		...
		GetAvatarActorFromActorInfo()->GetActorLocation() + (GetHeroCharacterFromActorInfo()->GetActorForwardVector() *
			BoxTraceDistance),
		TraceBoxSize / 2,
...
void UHeroGameplayAbility_TargetLock::GetAvailableActorsAroundTarget(TArray<AActor*>& OutActorOnLeft,
                                                                     TArray<AActor*>& OutActorOnRight)
{
	...
	for (AActor* AvailableActor : AvailableActorsToLock)
	{
		...
		{
			OutActorOnLeft.AddUnique(AvailableActor);
		}
	}
}
