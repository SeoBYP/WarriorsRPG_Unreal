...
namespace WarriorsGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_HitPuase, "Player.Ability.HitPuase")
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_HitPuase, "Player.Event.HitPuase")
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_ComsumeStones, "Player.Event.ComsumeStones")
