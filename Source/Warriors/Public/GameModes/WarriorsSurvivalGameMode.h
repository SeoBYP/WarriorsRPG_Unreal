...
#include "WarriorsSurvivalGameMode.generated.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSurvivalGameModeStateChangedDelegate, EWarriorSurvivalGameModeState,
                                            CurrentState);
 ...
 */
UCLASS()
class WARRIORS_API AWarriorsSurvivalGameMode : public AWarriorsBaseGameMode
{
	GENERATED_BODY()
